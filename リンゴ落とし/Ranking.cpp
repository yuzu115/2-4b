...
//* ランキング画面描画
//*****************************************/
//void Ranking::DrawRanking(XINPUT_STATE input, RankingData Ranking[], int& Button_flg, int& GameMode)
//{
//
//	ReadRanking(Ranking);		//ランキングデータの読込
//
...
// * ランキング並べ替え
// ***********************************************/
//void Ranking::SortRanking(RankingData Ranking[])
//{
//	int i, j;
//	RankingData work;
//
...
// * ランキングデータの保存
// ***********************************************/
//int  Ranking::SaveRanking(RankingData Ranking[])
//{
//	FILE* fp;
//#pragma warning(disable:4996)
//
...
// * ランキングデータ読み込み
// *************************************/
//int Ranking::ReadRanking(RankingData Ranking[])
//{
//	FILE* fp;
//#pragma warning(disable:4996)
//
...
// * ランキング画像読込
// *************************************/
//int Ranking::LoadRankingImages(void)
//{
//	// ランキング画像の読込
//	if ((RankingImg = LoadGraph("images/ranking.png")) == -1) return -1;
//
